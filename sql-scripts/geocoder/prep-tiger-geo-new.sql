...
select * from imt_geocoder('7 Co Hwy 34', 'WILLIAMSPORT,PA,US,17701', 1, 0.0, 0);            -- Fixed -- FAILS(2016,2017)
...
-- Total query runtime: 3.8 secs.  263 rows retrieved. (2017)
select * from imt_geocoder('101 7th St', 'Saint Paul, MN', 0, 0.0, 0);
-- Total query runtime: 452 ms.  259 rows retrieved.
-- Total query runtime: 417 msec 263 rows retrieved. -- 2017
select * from imt_geocoder('101 7th St', 'St. Paul, MN 55102', 0, 0.0, 0);
-- Total query runtime: 93 ms.  1 row retrieved.
-- Total query runtime: 101 msec 2 rows retrieved. -- 2017
