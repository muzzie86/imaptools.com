/*********************************************************************
*
*  $Id: rgeo2geo-sqlite.c,v 1.1 2010/05/08 04:23:36 woodbri Exp $
*
*  rgeo2geo
...
*  rgeo2geo-sqlite.c
*
*  $Log: rgeo2geo-sqlite.c,v $
*  Revision 1.1  2010/05/08 04:23:36  woodbri
*  Adding rgeo2geo-sqlite.c
*
*
**********************************************************************
*
...
void Usage()
{
    printf("Usage: rgeo2geo name.db Streets.dbf ...\n");
    exit(1);
}
